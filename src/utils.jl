...
"""
drawBoxes(img::AbstractArray, model::YOLO.yolo, padding::AbstractArray, bboxcolor::RGB, results; transpose=true) = drawBoxes!(copy(img), model, padding, bboxcolor, results, transpose=transpose)
function drawBoxes!(img::AbstractArray, model::YOLO.yolo, padding::AbstractArray, bboxcolor::RGB, results; transpose=true)
