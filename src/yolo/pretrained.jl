...
v2_608_COCO(;batch=1, silent=false, cfgchanges=nothing, kwargs...) = v2_COCO(;w=608, h=608, batch, silent, cfgchanges, kwargs...)
...
v2_tiny_416_COCO(;batch=1, silent=false, cfgchanges=nothing, kwargs...) = v2_tiny_COCO(;w=416, h=416, batch, silent, cfgchanges, kwargs...)
...
v3_320_COCO(;batch=1, silent=false, cfgchanges=nothing, kwargs...) = v3_COCO(;w=320, h=320, batch, silent, cfgchanges, kwargs...)
v3_416_COCO(;batch=1, silent=false, cfgchanges=nothing, kwargs...) = v3_COCO(;w=416, h=416, batch, silent, cfgchanges, kwargs...)
v3_608_COCO(;batch=1, silent=false, cfgchanges=nothing, kwargs...) = v3_COCO(;w=608, h=608, batch, silent, cfgchanges, kwargs...)
...
v3_spp_608_COCO(;batch=1, silent=false, cfgchanges=nothing, kwargs...) = v3_SPP_COCO(;w=608, h=608, batch, silent, cfgchanges, kwargs...)
...
v3_tiny_416_COCO(;batch=1, silent=false, cfgchanges=nothing, kwargs...) = v3_tiny_COCO(;w=416, h=416, batch, silent, cfgchanges, kwargs...)
