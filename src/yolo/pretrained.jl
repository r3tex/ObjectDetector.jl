## YOLOV2
function v2_COCO(;batch=1, silent=false, cfgchanges=nothing, w=608, h=608)
...
## YOLOV2-tiny
function v2_tiny_COCO(;batch=1, silent=false, cfgchanges=nothing, w=416, h=416)
    cfgchanges=[(:net, 1, :width, w), (:net, 1, :height, h)]
...
## YOLOV3 SPP
function v3_SPP_COCO(;batch=1, silent=false, cfgchanges=nothing, w=608, h=608)
    cfgchanges=[(:net, 1, :width, w), (:net, 1, :height, h)]
...
## YOLOV3-tiny
function v3_tiny_COCO(;batch=1, silent=false, cfgchanges=nothing, w=416, h=416)
    cfgchanges=[(:net, 1, :width, w), (:net, 1, :height, h)]
